...
public class LabelDeleteUseCase extends UseCase<LabelDeleteUseCase.Request, LabelDeleteUseCase.Response> {
    ...
    protected void executeUseCase(Request requestValues) {
        ...
        issueList.deleteLabelsBy(issueId);

        emit().onSuccess(new LabelDeleteUseCase.Response(issueList.getUncommittedChanges()));
